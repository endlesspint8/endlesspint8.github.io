...
According to the above graphic Strong Ales carry the highest median ABV at just under 10%; switching to IBU shows IPA's and Strong Ales  being neck and neck, with IPA's stetching further up the chart due to their outliers; when it comes to color Belgian Sytles and Porters have the largest range, but you'd be hard pressed to differentiate the shades of the latter without a <a href="https://en.wikipedia.org/wiki/Colorimeter_(chemistry)" target="_blank">measuring device</a>; lastly, the temperature rendering shows a ten degree Farenheit range for all beers.
